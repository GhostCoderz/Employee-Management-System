...
<body>
    ...
    <div class="container pt-4">
        <div class="row m-5 justify-content-center">
            ...
            <hr>
            <form id="form" class="border border-dark m-2 mt-4 col-md-10 text-left" action="UpdateProfile" method="post">
                <div class="row">
                    <div class="col-md-2">
                        <div class="m-3 me-1">
                            <label for="salutation" class="form-label ps-2">Salutation</label>
                            <input type="text" class="form-control" required id="salutation"value="<%=e.getSalutation() %>" name="salutation" disabled>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="m-3">
                            <label for="FName" class="form-label ps-2">First Name</label>
                            <input type="text" class="form-control" required id="FName" name="fname" value="<%=firstName %>" >
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="m-3">
                            <label for="LName" class="form-label ps-2">Last Name</label>
                            <input type="text" class="form-control" required id="LName" name="lname" value="<%=lastName %>" >
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="m-3">
                            ...
                            <%
                            	...
                            	{
                            %>
                            	<input type="text" class="form-control" required id="status" value="<%=e.getStatus() %>" name="status" disabled >
                            <%	
                            	}
                            	else
                            	{	
                    ...
                    <div class="col-md-4">
                        <div class="m-3">
                            ...
                            <input type="text" class="form-control" required id="department" value="<%=e.getDept() %>" name="deptName" disabled >
                        </div>
                    </div>
                    <div class="col-md-4 ">
                        <div class="form-check m-3">
                            <label for="gender" class="form-label" >Gender</label><br>
                            <input type="text" class="form-control" required id="gender" value="<%=e.getGender() %>" name="gender" disabled>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="m-3 col-md-8">
                            <label for="dob" class="form-label ps-2">Date Of Birth</label><br>
                            <input type="date" class="form-control" value="<%=e.getDob() %>" required id="dob" name="dob">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="m-3">
                            <label for="Email" class="form-label ps-2">Email</label>
                            <input type="email" class="form-control" required id="Email" aria-describedby="emailHelp" name="email" value="<%=e.getEmail() %>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="m-3">
                            <label for="mobNo" class="form-label ps-2">Mobile No.</label><br>
                            <input type="number" class="form-control" required id="mobNo" name="empNum" value="<%=e.getEmpNum() %>" >
                        </div>
                    </div>                    
                    <div class="col-md-4">
                        <div class="m-3">
                            <label for="address" class="form-label ps-2">Address</label><br>
                            <textarea class="form-control" required id="address" rows="2" name="street" ><%=e.getAddr().getStreet() %></textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="m-3">
                            <label for="city" class="form-label ps-2">City</label><br>
                            <input type="text" class="form-control" required id="city" name="city" value="<%=e.getAddr().getCity() %>" >
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="m-3">
                            <label for="state" class="form-label ps-2">State</label><br>
                            <input type="text" class="form-control" required id="state" name="state" value="<%=e.getAddr().getState() %>" >
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="m-3">
                            <label for="country" class="form-label ps-2">Nationality</label><br>
                            <input type="text" class="form-control" required id="country" name="country" value="<%=e.getAddr().getCountry() %>" >
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="m-3">
                            <label for="pin" class="form-label ps-2">Pincode</label><br>
                            <input type="number" class="form-control" required id="pin" name="pin" value="<%=e.getAddr().getPincode() %>" >
                        </div>
                    </div>
                </div>
                <div class="row">
