        ...
        <div class="container">
            <div class="row no-gutters justify-content-center">
              <div class="col-lg-5 p-0">
                  <img src="assets/image/employee1.jpg"m class="img-fluid" alt="Image">
              </div>
              <div class="col-lg-7 px-5 pt-5">
                  ...
                  <form action="/dashboard" method="POST">
                      ...
                      <div class="form-row">
                          <div class="col-lg-8">
                              <input type="password" placeholder="Password" name="password" class="form-control my-3 p-3" required id="pass">
                          </div>
                      </div>
                      <div class="form-row">
                        <div class="col-lg-8">
                      ...
                      <div class="form-row">
                          <div class="col-lg-8">
                              <input type="submit" value="Login" name="" class="form-control my-3 p-2 mt-3 mb-5" required id="login">
                          </div>
                      </div>
